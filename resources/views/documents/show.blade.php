    ...
    <div class="modal fade" id="modal-forward">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="submitPermission">Submit</button>
                </div>
            </div>
        </div>
        {{ Form::close() }}
    ...
    <div class="form-group">
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                ...
                <button class="dropdown-item" type="button" name="action" value="approvef" id="approveAndForward" onclick="getData(event)">
...
<script>
    ...
    document.getElementById("approveAndForward").addEventListener("click", function() {
        $('#modal-forward').modal('show');
        document.getElementById("permissionForm").submit(); 
    });
</script>
<script>
    function openModalAndPreventSubmit(event) {
    ...
    function handleModalClosedAction() {
